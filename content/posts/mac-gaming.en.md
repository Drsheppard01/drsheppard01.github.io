...
Here, Linux gaming is a more interesting story: the audience is 1,5-2x larger[^1], 27,000 games among the verified ones (including native ones)[^2], and no official clients, but a sea of ​​unofficial ones, such as Heroic, Minigalaxy, Lutris, the defunct GameHub, and a huge number of gaming tools like MangoHUD, Piper, Oversteer, etc.
