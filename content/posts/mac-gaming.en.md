+++
title = "A few words about gaming on macOS"
date = "2026-04-25"
description = "Difference with gaming on Mac and gaming on Linux?"
[taxonomies]
...
Here, Linux gaming is a more interesting story: the audience is 2-3 times larger (see Steam statistics + the release of Steam Deck), 27,000 games among the verified ones (including native ones), and no official clients, but a sea of ​​unofficial ones, such as Heroic, Minigalaxy, Lutris, the defunct GameHub, and a huge number of gaming tools like MangoHUD, Piper, Oversteer, etc.
